...
static const MCGLColor RED(1.0, 0.1, 0.2);
static const MCGLColor GREEN(0.0, 1.0, 0.8);
static const MCGLColor YELLOW(1.0, 0.6, 0.0);
static const MCGLColor WHITE(0.4, 0.8, 1.0);
