...
void CheckeredFlag::render()
{
    ...
    const float pulse = 1.0f + 0.15f * std::sin(m_animFrame * 0.15f);

    m_surface->setColor(MCGLColor(1.0f, 1.0f, 1.0f, 1.0f));
    m_surface->setSize(static_cast<int>(FLAG_W * pulse), static_cast<int>(FLAG_H * pulse));
